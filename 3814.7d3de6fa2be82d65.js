...
const Toggle = class {
  constructor(hostRef) {
     ...
     */
    this.required = false;
    this.setupGesture = /*#__PURE__*/(0,_Users_aryan_Documents_officeprojects_ionic_ts_operator_ionic4_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
    ...
    this.onClick = ev => {
       ...
       * only trigger on iOS.
       */
      const enableHaptics = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_4__.a)('ios');
      if (this.disabled) {
        return;
      }
      ev.preventDefault();
  ...
  renderHintText() {
    ...
    }, helperText), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: errorTextId,
      class: "error-text",
