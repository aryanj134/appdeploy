...
const Toggle = class {
  constructor(hostRef) {
     ...
     */
    this.required = false;
    this.setupGesture = /*#__PURE__*/(0,_Users_aryan_Documents_officeprojects_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
