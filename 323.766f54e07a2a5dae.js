...
const SegmentView = class {
  ...
  setContent(_x) {
    var _this = this;
    return (0,_Users_aryan_Documents_officeprojects_ionic_ts_operator_ionic4_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (id, smoothScroll = true) {
