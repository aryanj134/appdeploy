...
const PickerColumn = class {
  ...
  componentWillLoad() {
    ...
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector(`.${PICKER_ITEM_ACTIVE_CLASS}`);
        if (oldActive) {
  ...
  scrollActiveItemIntoView() {
    var _this = this;
    return (0,_Users_raja_Documents_officeProjects_Live_issues_capacitor_ionic_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (smooth = false) {
