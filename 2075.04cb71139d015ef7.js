...
/* harmony import */ var _overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-BymNv-BL.js */ 63220);
...
/* harmony import */ var _hardware_back_button_CPLxO_Ev_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hardware-back-button-CPLxO-Ev.js */ 49431);
/* harmony import */ var _helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers-DEn3pfjm.js */ 64674);
/* harmony import */ var _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-CvDIirVx.js */ 49081);
...
/* harmony import */ var _framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./framework-delegate-BYawdMXj.js */ 86118);
/* harmony import */ var _animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./animation-Dt8bGnA-.js */ 22541);
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.handleFocus = ev => {
       ...
       */
      const lastOverlay = (0,_overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__.o)(document);
  ...
  onBackdropClick(ev) {
    ...
    if (this._isOpen && this.lastOnEnd < ev.timeStamp - 100) {
      ...
      if (shouldClose) {
        ev.preventDefault();
        ev.stopPropagation();
        this.close(undefined, _overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__.B);
      }
    }
  }
  onKeydown(ev) {
  ...
  trapKeyboardFocus(ev, doc) {
    ...
    if (this.el.contains(target)) {
       ...
       * here to avoid that.
       */
      (0,_overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__.n)(el);
      /**
      ...
      if (this.lastFocus === doc.activeElement) {
        (0,_overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__.q)(el);
      }
    }
  }
  _setOpen(_x) {
    var _this4 = this;
    return (0,_Users_aryan_Documents_officeprojects_ionic_ts_operator_ionic4_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (shouldOpen, animated = true, role) {
  ...
  onWillStart() {
    this.beforeAnimation(!this._isOpen, _overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__.G);
  ...
  onEnd(detail) {
    ...
    this.animation.easing('cubic-bezier(0.4, 0.0, 0.6, 1)').onFinish(() => this.afterAnimation(shouldOpen, _overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__.G), {
  ...
  updateState() {
    ...
    if (!isActive) {
       ...
       */
      this.afterAnimation(false, _overlays_BymNv_BL_js__WEBPACK_IMPORTED_MODULE_3__.G);
    }
  }
  render() {
    const {
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,_Users_aryan_Documents_officeprojects_ionic_ts_operator_ionic4_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (menu) {
...
const MenuButton = class {
  constructor(hostRef) {
     ...
     */
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,_Users_aryan_Documents_officeprojects_ionic_ts_operator_ionic4_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
